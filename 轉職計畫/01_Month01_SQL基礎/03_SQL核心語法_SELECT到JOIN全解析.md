...
> [!TIP]
> 💡 **記憶口訣**：`COALESCE` = 「遇到 NULL 就換成 ***」；`NULLIF` = 「遇到*** 就變成 NULL」。在 03 題庫的跨表查詢（如 Q23、Q24、Q26、Q29、Q30）中會大量用到！
...
恭喜你完成 03 篇核心語法的洗禮！現在你已經具備了解答真實商業問題的能力。

請準備好進入實戰題庫 [`06_30道B2B商業SQL實戰練習題.md`](./06_30道B2B商業SQL實戰練習題.md)，建議依照下列階梯節奏進行手寫挑戰：

| 挑戰階段 | 對應 03 篇關卡 | 題庫題號 | 核心技能目標 |
| :----------------: | :------------- | :-----------------: | :---------------------------------------- |
...
👉 **立即前往手寫實戰**：[06_30道B2B商業SQL實戰練習題.md](./06_30道B2B商業SQL實戰練習題.md)
...
- **前一篇**：[01_環境建置_PostgreSQL安裝與DBeaver連線.md](./01_環境建置_PostgreSQL安裝與DBeaver連線.md)（環境建置與連線驗證）
- **下一篇（拆解思維）**：[04_SQL商業問題拆解框架.md](./04_SQL商業問題拆解框架.md)（5 Level 拆解框架，動手寫 SQL 前先規劃）
- **實戰手寫題庫**：[06_30道B2B商業SQL實戰練習題.md](./06_30道B2B商業SQL實戰練習題.md)（30 道 B2B 商業實戰自測題）
- **避坑必備**：[05_JOIN陷阱與資料粒度問題.md](./05_JOIN陷阱與資料粒度問題.md)（深入了解 1:N 笛卡兒積與金額膨脹）
