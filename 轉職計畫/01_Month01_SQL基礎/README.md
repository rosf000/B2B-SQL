...
我們將本月拆解為 4 個循序漸進的階段，**全系列 10 份文件完全線性編排（01 ➜ 10）**：

```mermaid
flowchart TD
    S1["第 1 步：環境建立與全月規劃 (預估 1 小時)<br/>閱讀 01 指南 ➜ 安裝 PostgreSQL & DBeaver ➜ 建立 GitHub ➜ 閱讀 02 計畫"]
    S2["第 2 步：資料庫探索與語法闖關 (預估 1 週)<br/>閱讀 03 指南看懂 5 張表 Schema ➜ 邊看 04 講義邊敲 5 大關卡 ➜ 掌握 05 除錯心法"]
    S3["第 3 步：跨表深挖與商業拆解 (預估 3-4 天)<br/>掌握 06 粒度陷阱與 Fan-out ➜ 學會 07 商業拆解 5 步驟 ➜ 建立 08 AI 助教工作流"]
    S4["第 4 步：實戰大練兵與結業晉級 (預估 1-2 週)<br/>挑戰 09 實戰題庫 30 題 ➜ 產出 Mini Project ➜ 閉卷挑戰 10 Exit Exam (80分晉級)！"]
...
| :---: | :--- | :--- | :---: |
| **01** | [01_環境建置_PostgreSQL安裝與DBeaver連線.md](./01_環境建置_PostgreSQL安裝與DBeaver連線.md) | 避開 Stack Builder 陷阱、DBeaver 連線、匯入資料，以及 VS Code 內建一鍵建立 GitHub Repo 與每日 Commit 流程 | 30 分鐘 |
| **02** | [02_本月學習計畫與目標.md](./02_本月學習計畫與目標.md) | 四週線性學習計畫、本月目標設定與節奏規劃 | 15 分鐘 |
| **03** | [03_讀懂陌生資料庫的五步驟.md](./03_讀懂陌生資料庫的五步驟.md) | **探索起手式**：面對新資料庫的探索 SOP、DBeaver 視覺化看表、PK/FK 與資料粒度認知 | 1 天 |
| **04** | [04_SQL核心語法_SELECT到JOIN全解析.md](./04_SQL核心語法_SELECT到JOIN全解析.md) | B2B 資料庫 ER 關係圖、5 大階梯式實戰關卡、底層執行順序解密 | 2~3 天 |
| **05** | [05_SQL除錯方法論.md](./05_SQL除錯方法論.md) | **除錯自救 SOP**：系統化 SQL Debug 流程、Syntax/Logic/Data 常見錯誤排除方法 | 0.5 天 |
| **06** | [06_JOIN陷阱與資料粒度問題.md](./06_JOIN陷阱與資料粒度問題.md) | **粒度防坑專題**：Data Grain 概念、JOIN 後資料重複 (Fan-out) 的根源與防範 | 1 天 |
| **07** | [07_SQL商業問題拆解框架.md](./07_SQL商業問題拆解框架.md) | **商業思維轉換**：看到商業需求如何拆解成 SQL 的系統化思維框架 | 1 天 |
...
- [ ] 建立自己的 GitHub 作品庫（`B2B-SQL`），熟練在 VS Code 中完成每日練習的 Git Commit 與 Push。
