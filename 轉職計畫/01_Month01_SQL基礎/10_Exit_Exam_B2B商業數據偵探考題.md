...
- **題目要求**：
  ...
  3. 依累計消費金額由高至低排序。
- **交付成果**：SQL 代碼 + 針對 Top 1 客戶的商業維護建議。
...
- **題目要求**：
  ...
  - 依沉睡天數由大到小排序。
- **交付成果**：SQL 代碼 + 告訴業務團隊應優先聯繫哪一類產業客戶。
...
- **交付成果**：SQL 代碼 + 一句管理建議（哪位業務客單價最高？哪位是走薄利多銷路線？）。
...
- [ ] 正確指出實習生代碼中的 Multi-JOIN 笛卡兒積/重疊計算錯誤並給予修復
