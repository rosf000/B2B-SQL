...
4. [04_Exit_Exam_與面試規格升級指南.md](./04_Exit_Exam_與面試規格升級指南.md)
   - 🎓 **本月結業測驗**：MoM 滾動增長率、NTILE RFM 分群實作，以及「1億筆巨量資料下的 Index 設計與 Trade-off」面試考題。
   - 🚀 **Project 1 面試化重構指南**：8 步標準商業敘事架構，擺脫學校作業感。
5. [Project_01_銷售資料多維度分析專案/](./Project_01_銷售資料多維度分析專案/README.md)
